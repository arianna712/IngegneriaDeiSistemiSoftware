...
class Firefly_2 ( name: String, scope: CoroutineScope, isconfined: Boolean=false, isdynamic: Boolean=true ) : 
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					action { //it:State
						CommUtils.outyellow("$name | X=$X Y=$Y  Timer=$Timer")
				...
				state("flash") { //this:State
					...
					transition(edgeName="t03",targetState="handlecoordinate",cond=whenDispatch("sync"))
				}	 
